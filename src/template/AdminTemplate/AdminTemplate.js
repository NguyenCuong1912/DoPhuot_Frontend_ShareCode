        ...
        <div className="flex">
          <NavLink to="/profile" className="flex">
            <img
              ...
              src="https://phuotbuistore.com/wp-content/uploads/2018/11/Untitled-1.png"
            ...
            <span className="flex items-center border-r-2 border-green-900 text-lg font-bold mx-4 pr-4 cursor-pointer text-black">
              Xin chào!, {userLogin.account.Username}
            </span>
          </NavLink>
          <button
            onClick={() => {
            ...
            className="self-center mr-8 px-4 py-3 border border-yellow-500 rounded-lg text-yellow-500 text-lg font-bold hover:text-white hover:bg-yellow-500"
          >
            Đăng xuất
          </button>
        </div>
          ...
          <Fragment>
            <Layout style={{ minHeight: "100vh" }}>
              ...
              >
                ...
                >
                  <Menu.Item key="0">
                    <NavLink className="text-black nav-link" to={`${_admin}`}>
                      Dashboard
                    </NavLink>
                  </Menu.Item>
                  <Menu.Item key="1">
